...
.ForMember(d => d.Code, o => o.MapFrom(s => s.Code.ToUpper()));
    ...
    .ForMember(dest => dest.IsExtended, opt => opt.MapFrom(src => src.IsExtended));
                ...
                .ForMember(dest => dest.Location, opt => opt.MapFrom(src => src.Location != null ? src.Location.LocationName : "Chennai"))
                .ForMember(dest => dest.PricePerDay, opt => opt.MapFrom(src => src.PricePerDay ?? 1500.00m))
